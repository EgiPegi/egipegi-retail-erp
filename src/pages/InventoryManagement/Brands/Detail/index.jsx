...
const BrandDetail = () => {
    ...
    useEffect(() => {
        if (!prepAddEdit.isShown) {
            inventoryService.getBrandById(param.slug).then(x => {
                console.log(x)
                setDatas(x)
            });
        }
    ...
    return (
        <div>
            {
                datas && <div className="mb-5 p-5 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
